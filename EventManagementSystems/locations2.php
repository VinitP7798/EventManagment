                ...
                <section>
                    <div class="container">
                                    ...
                                    <div class="row">
                                        <div class="modal-body"><!--modal content-->
                                            ...
                                            <div class="modaltext1 col-md-6">
                                                ...
                                                <p>
                                                Sitting amongst historic sandstone, Bluet
                        ...
                        <div class="subcontent col-md-8"><!--location non modal content -->
                            <h1 class="title">Bluet</h1><!--location title-->
                            <p class="location"><!--location secondary content-->
                            Lokhandwala
                            </p>
                            <p class="definition"><!--content body-->
                            Sitting amongst historic sandstone, Bluet is the epitome of elegance for a sophisticated celebration.When you dine in the 
                            Bluet, you can choose from our award winning Saké Restaurant
            ...
            <div class="row"><!--location content -->
                <section>
                    <div class="container">
                        ...
                        <div class="modal fade" id="ananasbar" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"><!--location modal content-->
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header"><!--modal header-->
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button><!--close button on top-->
                                        <h4 class="modal-title" id="myModalLabel">The Peshwai's Pavillion</h4><!--modal title-->
                                    </div>
                                    <div class="row">
                                        <div class="modal-body"><!--modal content-->
                                            <div class="col-md-6"><!--image holder with 6 grid column-->
                                            ...
                                            <div class="modaltext1 col-md-6">
                                                ...
                                                <p>
                                                Champagne imbibing, glamorous, smiling and flirting, The Peshwai's Pavillion
                                                is the Mumbai Sophisticate’s adult playground.
                                                </p>
                                            </div> 
                                            <div class="modaltext2 col-md-12">
                                                <p>
                                                Awarded a Chef’s Hat in the 2014 Good Food Guide Awards,
                                                ...
                                                looking for a late night dining experience, The Peshwai's Pavillion has you covered.
                                                </p>
                                            </div>
                                        </div><!--modal body-->
                                    </div>
                        ...
                        <div class="subcontent col-md-8"><!--location non modal content -->
                            <h1 class="title">The Peshwai's Pavillion</h1><!--location title-->
                            <p class="location">Andheri West, Mumbai</p><!--location secondary content-->
                            <p class="definition">
                            The Peshwai's Pavillion is the Mumbai Sophisticate’s adult playground.
                ...
                <section>
                    <div class="container">
                        ...
                        <div class="modal fade" id="argyle" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"><!--location modal content-->
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header"><!--modal header-->
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button><!--close button on top-->
                                        <h4 class="modal-title" id="myModalLabel">Bombay Xchange</h4><!--modal title-->
                                    </div>
                                    <div class="row">
                                        <div class="modal-body"><!--modal content-->
                                            <div class="col-md-6"><!--image holder with 6 grid column-->
                                            ...
                                            <div class="modaltext1 col-md-6">
                                                ...
                                                <p>
                                                There’s no question that The Rocks is home to some of Mumbai’s most intriguing historical stories. And
                                                our landmark venue, Bombay Xchange, has a unique, rich history all of its own.
                                                </p>
                                            </div> 
                                            <div class="modaltext2 col-md-12">
                                                <p>
                        ...
                        <div class="subcontent col-md-8">
                            <h1 class="title">Bombay Xchange</h1>
                            <p class="location">BKC</p>
                            <p class="definition">There’s no question that The Rocks is home to some of Mumbai’s most intriguing historical stories.
                                And our landmark venue, Bombay Xchange, has a unique, rich history all of its own. The sandstone walls that house
                                Bombay Xchange had seen some interesting sights well before we all hit the dance floor.</p>
            ...
            <div class="row"><!--location content -->
                <section>
                    <div class="container">
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header"><!--modal header-->
                                        ...
                                        <h4 class="modal-title" id="myModalLabel">Red Stone</h4><!--modal title-->
                                    </div>
                                    <div class="row">
                                        <div class="modal-body"><!--modal content-->
                                            <div class="col-md-6"><!--image holder with 6 grid column-->
                                            ...
                                            <div class="modaltext1 col-md-6">
                                                <h5>THE BEST OF CUISINE AT SOUTH BOMBAY</h5>
                                                <p>
                                                ...
                                                located in the heart of Mumbai’s bustling South Wharf.
                                                </p>
                                            </div> 
                                            <div class="modaltext2 col-md-12">
                                                <p>
                                                The uber venue is our latest venture, bringing to life a traditional
                                                Red Stone bier haus, where you can dink drink and party like Oktoberfest never ended. The state-of-the-art venue seats
                                                over 900 people and is located opposite the Mumbai 
                                                </p>
                        ...
                        <div class="subcontent col-md-8">
                            <h1 class="title">Red Stone</h1>
                            <p class="location">Altamount Road</p>
                            <p class="definition">The uber venue is our latest venture, bringing to life a traditional
                            Red Stone's bier haus, where you can dink drink and party like Oktoberfest never ended.
                                The state-of-the-art venue seats over 900 people and is located opposite the Mumbai
                                .</p>
                            <hr class="customline3">   
